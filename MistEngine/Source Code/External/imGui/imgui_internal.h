...
#ifdef _WIN32
#define IM_NEWLINE                      "\r\n"   // Play it nice with Windows users (UpdateAABB: since 2018-05, Notepad finally appears to support Unix-style carriage returns!)
#else
#define IM_NEWLINE                      "\n"
#endif
...
struct IMGUI_API ImGuiMenuColumns
{
    ...
    ImU16       OffsetLabel;        // Offsets are locked in UpdateAABB()
...
struct ImGuiViewportP : public ImGuiViewport
{
    ...
    void    UpdateWorkRect()            { WorkPos = CalcWorkRectPos(WorkOffsetMin); WorkSize = CalcWorkRectSize(WorkOffsetMin, WorkOffsetMax); } // UpdateAABB public fields
